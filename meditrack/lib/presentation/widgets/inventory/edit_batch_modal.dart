...
class EditBatchModal extends ConsumerStatefulWidget {
  final InventoryTable batch;
  final int medicationId;

  const EditBatchModal(
      {super.key, required this.batch, required this.medicationId});

  @override
  ConsumerState<EditBatchModal> createState() => _EditBatchModalState();
}

class _EditBatchModalState extends ConsumerState<EditBatchModal> {
  ...
  void initState() {
    ...
    _quantityController =
        TextEditingController(text: widget.batch.quantity.toString());
    _selectedExpirationDate = widget.batch.expirationDate;
  }
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await ref.read(inventoryNotifierProvider.notifier).updateInventory(
